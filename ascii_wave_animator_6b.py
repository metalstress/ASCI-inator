...
class MainWindow(QWidget):
    ...
    def import_palette(self):
        ...
        # Viewport can look smooth because it refreshes frequently; if we keep export FPS low,
        # the animation advances too much per frame (big dt) and looks jerky.
        base = 30
        try:
