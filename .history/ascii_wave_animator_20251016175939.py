...
class ScrollableTabBar(QWidget):
    ...
    def __init__(self, tab_names):
        ...
        self.btn_left.setFixedSize(0, 0)
        ...
        for i, name in enumerate(tab_names):
            ...
            self.tab_buttons.append(btn)
            tabs_layout.addWidget(btn)
        # Растянуть контейнер табов по ширине, чтобы все баблы умещались без обрезания
        spacer = QWidget(); spacer.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        tabs_layout.addWidget(spacer)
        ...
        self.btn_right.setFixedSize(0, 0)
